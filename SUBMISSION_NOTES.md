...
**Release:** This manuscript corresponds to GitHub release `v2.2.6`.
...
**Comments:** 26 pages. Corresponds to GitHub release `v2.2.6`.

**License:** Creative Commons Attribution 4.0 International (CC BY 4.0)

**Current public research release:** `v2.2.6`
