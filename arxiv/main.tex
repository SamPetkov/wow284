...
WOW-284 is equivalent to a two-sided adjacency-spectrum window centred at
\(-1\); see Theorem~\ref{thm:diameter-three-score}.
...
form recorded in Backelin's Lemma~2.1 \cite{Backelin2015}.
\end{proof}
...
the Hoffman--Singleton graph also appears in
...
For Moore punctures, \(E_S\) is an explicit distance-increase matrix; the exact
