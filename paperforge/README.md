...
- `../main.tex` remains the only editable manuscript source.
- `source/` and `output/` are generated by Paperforge and are never hand-edited.
...
environment, pins Paperforge and PreTeXt, generates the interactive paper,
assembles the project pages, and runs the smoke tests:
