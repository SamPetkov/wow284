...
def main() -> None:
    ...
    require(r"\newcommand{\RepoTag}{v2.2.1}" in tex, "v2.2 release tag missing")
    ...
    require(
        r"correspond to release \texttt{v2.2.1}" in tex,
    ...
    require(
        "**Current public research release:** `v2.2.1`" in submission_notes,
