...
set_option maxRecDepth 25000 in
lemma ldl_scaled_identity_int_rows_5_8 : ∀ c d : Fin 5,
    (BpadInt * WpadInt * BpadInt.transpose) (coordPad 5 c) (coordPad 8 d) =
      (MscaledPadInt) (coordPad 5 c) (coordPad 8 d) := by
  intro c d
  fin_cases c <;> fin_cases d <;> decide

lemma ldl_scaled_identity_int_row_5 (s : Fin 9) (c d : Fin 5) :
  ...
  · exact ldl_scaled_identity_int_rows_5_8 c d
