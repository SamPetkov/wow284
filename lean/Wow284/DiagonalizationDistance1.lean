...
lemma distance_diagonalization_int_rows_1_0 : ∀ c d : Fin 5,
    (D * eigenbasisInt) (coordVertex 1 c) (coordVertex 0 d) =
...
lemma distance_diagonalization_int_rows_1_1 : ∀ c d : Fin 5,
    (D * eigenbasisInt) (coordVertex 1 c) (coordVertex 1 d) =
...
lemma distance_diagonalization_int_rows_1_2 : ∀ c d : Fin 5,
    (D * eigenbasisInt) (coordVertex 1 c) (coordVertex 2 d) =
...
lemma distance_diagonalization_int_rows_1_3 : ∀ c d : Fin 5,
    (D * eigenbasisInt) (coordVertex 1 c) (coordVertex 3 d) =
...
lemma distance_diagonalization_int_rows_1_4 : ∀ c d : Fin 5,
    (D * eigenbasisInt) (coordVertex 1 c) (coordVertex 4 d) =
...
lemma distance_diagonalization_int_rows_1_5 : ∀ c d : Fin 5,
    (D * eigenbasisInt) (coordVertex 1 c) (coordVertex 5 d) =
...
lemma distance_diagonalization_int_rows_1_6 : ∀ c d : Fin 5,
    (D * eigenbasisInt) (coordVertex 1 c) (coordVertex 6 d) =
...
lemma distance_diagonalization_int_rows_1_7 : ∀ c d : Fin 5,
    (D * eigenbasisInt) (coordVertex 1 c) (coordVertex 7 d) =
      (eigenbasisInt * distanceDiagonalInt) (coordVertex 1 c) (coordVertex 7 d) := by
  decide

set_option maxRecDepth 10000 in
lemma distance_diagonalization_int_rows_1_8 : ∀ c d : Fin 5,
    (D * eigenbasisInt) (coordVertex 1 c) (coordVertex 8 d) =
      (eigenbasisInt * distanceDiagonalInt) (coordVertex 1 c) (coordVertex 8 d) := by
  decide

set_option maxRecDepth 10000 in
lemma distance_diagonalization_int_rows_1_9 : ∀ c d : Fin 5,
    (D * eigenbasisInt) (coordVertex 1 c) (coordVertex 9 d) =
      (eigenbasisInt * distanceDiagonalInt) (coordVertex 1 c) (coordVertex 9 d) := by
  decide

lemma distance_diagonalization_int_row_1 (s : Fin 10) (c d : Fin 5) :
    (D * eigenbasisInt) (coordVertex 1 c) (coordVertex s d) =
  ...
  · exact distance_diagonalization_int_rows_1_8 c d
  · exact distance_diagonalization_int_rows_1_9 c d
