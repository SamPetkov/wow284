import Wow284.DiagonalizationLeft0
import Wow284.DiagonalizationLeft1
import Wow284.DiagonalizationLeft2
import Wow284.DiagonalizationLeft3
import Wow284.DiagonalizationLeft4
import Wow284.DiagonalizationLeft5
import Wow284.DiagonalizationLeft6
import Wow284.DiagonalizationLeft7
import Wow284.DiagonalizationLeft8
import Wow284.DiagonalizationLeft9
...
private lemma eigenbasis_left_inverse_scaled_coord (r s : Fin 10) (c d : Fin 5) :
  ...
  · exact eigenbasis_left_inverse_scaled_row_8 s c d
  · exact eigenbasis_left_inverse_scaled_row_9 s c d

theorem eigenbasis_left_inverse_scaled :
    eigenbasisInvNumerator * eigenbasisInt = scaledIdentityInt := by
  ext i j
