...
lemma distance_diagonalization_int_rows_7_0 : ∀ c d : Fin 5,
    (Dcert * eigenbasisInt) (coordVertex 7 c) (coordVertex 0 d) =
...
lemma distance_diagonalization_int_rows_7_1 : ∀ c d : Fin 5,
    (Dcert * eigenbasisInt) (coordVertex 7 c) (coordVertex 1 d) =
...
lemma distance_diagonalization_int_rows_7_2 : ∀ c d : Fin 5,
    (Dcert * eigenbasisInt) (coordVertex 7 c) (coordVertex 2 d) =
...
lemma distance_diagonalization_int_rows_7_3 : ∀ c d : Fin 5,
    (Dcert * eigenbasisInt) (coordVertex 7 c) (coordVertex 3 d) =
...
lemma distance_diagonalization_int_rows_7_4 : ∀ c d : Fin 5,
    (Dcert * eigenbasisInt) (coordVertex 7 c) (coordVertex 4 d) =
...
lemma distance_diagonalization_int_rows_7_5 : ∀ c d : Fin 5,
    (Dcert * eigenbasisInt) (coordVertex 7 c) (coordVertex 5 d) =
...
lemma distance_diagonalization_int_rows_7_6 : ∀ c d : Fin 5,
    (Dcert * eigenbasisInt) (coordVertex 7 c) (coordVertex 6 d) =
...
lemma distance_diagonalization_int_rows_7_7 : ∀ c d : Fin 5,
    (Dcert * eigenbasisInt) (coordVertex 7 c) (coordVertex 7 d) =
      (eigenbasisInt * distanceDiagonalInt) (coordVertex 7 c) (coordVertex 7 d) := by
  decide

lemma distance_diagonalization_int_row_7 (s : Fin 8) (c d : Fin 5) :
    (Dcert * eigenbasisInt) (coordVertex 7 c) (coordVertex s d) =
