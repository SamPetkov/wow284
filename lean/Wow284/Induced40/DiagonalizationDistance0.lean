...
lemma distance_diagonalization_int_rows_0_0 : ∀ c d : Fin 5,
    (Dcert * eigenbasisInt) (coordVertex 0 c) (coordVertex 0 d) =
...
lemma distance_diagonalization_int_rows_0_1 : ∀ c d : Fin 5,
    (Dcert * eigenbasisInt) (coordVertex 0 c) (coordVertex 1 d) =
...
lemma distance_diagonalization_int_rows_0_2 : ∀ c d : Fin 5,
    (Dcert * eigenbasisInt) (coordVertex 0 c) (coordVertex 2 d) =
...
lemma distance_diagonalization_int_rows_0_3 : ∀ c d : Fin 5,
    (Dcert * eigenbasisInt) (coordVertex 0 c) (coordVertex 3 d) =
...
lemma distance_diagonalization_int_rows_0_4 : ∀ c d : Fin 5,
    (Dcert * eigenbasisInt) (coordVertex 0 c) (coordVertex 4 d) =
...
lemma distance_diagonalization_int_rows_0_5 : ∀ c d : Fin 5,
    (Dcert * eigenbasisInt) (coordVertex 0 c) (coordVertex 5 d) =
...
lemma distance_diagonalization_int_rows_0_6 : ∀ c d : Fin 5,
    (Dcert * eigenbasisInt) (coordVertex 0 c) (coordVertex 6 d) =
...
lemma distance_diagonalization_int_rows_0_7 : ∀ c d : Fin 5,
    (Dcert * eigenbasisInt) (coordVertex 0 c) (coordVertex 7 d) =
      (eigenbasisInt * distanceDiagonalInt) (coordVertex 0 c) (coordVertex 7 d) := by
  decide

lemma distance_diagonalization_int_row_0 (s : Fin 8) (c d : Fin 5) :
    (Dcert * eigenbasisInt) (coordVertex 0 c) (coordVertex s d) =
