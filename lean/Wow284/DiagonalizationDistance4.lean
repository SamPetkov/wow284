...
lemma distance_diagonalization_int_rows_4_0 : ∀ c d : Fin 5,
    (D * eigenbasisInt) (coordVertex 4 c) (coordVertex 0 d) =
...
lemma distance_diagonalization_int_rows_4_1 : ∀ c d : Fin 5,
    (D * eigenbasisInt) (coordVertex 4 c) (coordVertex 1 d) =
...
lemma distance_diagonalization_int_rows_4_2 : ∀ c d : Fin 5,
    (D * eigenbasisInt) (coordVertex 4 c) (coordVertex 2 d) =
...
lemma distance_diagonalization_int_rows_4_3 : ∀ c d : Fin 5,
    (D * eigenbasisInt) (coordVertex 4 c) (coordVertex 3 d) =
...
lemma distance_diagonalization_int_rows_4_4 : ∀ c d : Fin 5,
    (D * eigenbasisInt) (coordVertex 4 c) (coordVertex 4 d) =
...
lemma distance_diagonalization_int_rows_4_5 : ∀ c d : Fin 5,
    (D * eigenbasisInt) (coordVertex 4 c) (coordVertex 5 d) =
...
lemma distance_diagonalization_int_rows_4_6 : ∀ c d : Fin 5,
    (D * eigenbasisInt) (coordVertex 4 c) (coordVertex 6 d) =
...
lemma distance_diagonalization_int_rows_4_7 : ∀ c d : Fin 5,
    (D * eigenbasisInt) (coordVertex 4 c) (coordVertex 7 d) =
      (eigenbasisInt * distanceDiagonalInt) (coordVertex 4 c) (coordVertex 7 d) := by
  decide

set_option maxRecDepth 10000 in
lemma distance_diagonalization_int_rows_4_8 : ∀ c d : Fin 5,
    (D * eigenbasisInt) (coordVertex 4 c) (coordVertex 8 d) =
      (eigenbasisInt * distanceDiagonalInt) (coordVertex 4 c) (coordVertex 8 d) := by
  decide

set_option maxRecDepth 10000 in
lemma distance_diagonalization_int_rows_4_9 : ∀ c d : Fin 5,
    (D * eigenbasisInt) (coordVertex 4 c) (coordVertex 9 d) =
      (eigenbasisInt * distanceDiagonalInt) (coordVertex 4 c) (coordVertex 9 d) := by
  decide

lemma distance_diagonalization_int_row_4 (s : Fin 10) (c d : Fin 5) :
    (D * eigenbasisInt) (coordVertex 4 c) (coordVertex s d) =
  ...
  · exact distance_diagonalization_int_rows_4_8 c d
  · exact distance_diagonalization_int_rows_4_9 c d
