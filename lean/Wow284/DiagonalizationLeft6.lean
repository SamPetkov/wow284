...
set_option maxRecDepth 10000 in
lemma eigenbasis_left_inverse_scaled_rows_6_8 : ∀ c d : Fin 5,
    (eigenbasisInvNumerator * eigenbasisInt) (coordVertex 6 c) (coordVertex 8 d) =
      (scaledIdentityInt) (coordVertex 6 c) (coordVertex 8 d) := by
  decide

set_option maxRecDepth 10000 in
lemma eigenbasis_left_inverse_scaled_rows_6_9 : ∀ c d : Fin 5,
    (eigenbasisInvNumerator * eigenbasisInt) (coordVertex 6 c) (coordVertex 9 d) =
      (scaledIdentityInt) (coordVertex 6 c) (coordVertex 9 d) := by
  decide

lemma eigenbasis_left_inverse_scaled_row_6 (s : Fin 10) (c d : Fin 5) :
  ...
  · exact eigenbasis_left_inverse_scaled_rows_6_8 c d
  · exact eigenbasis_left_inverse_scaled_rows_6_9 c d
