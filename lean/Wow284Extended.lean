...
/-!
Top-level imports for the WOW-284 extension package.

Files ending in `.lean.template` are deliberately excluded.  They record the
remaining generic matrix wrappers for a subsequent kernel-checked pass.
-/
