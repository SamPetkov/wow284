...
| The all-degree one-variable LP optimum and optimizer rigidity are formalized in Lean. | `lean/Wow284/LPCeiling.lean`, `lean/Wow284LPAudit.lean`, and the pinned public build. | Proved as a graph-independent analytic theorem; the graph trace bridge is not part of this Lean claim. |
