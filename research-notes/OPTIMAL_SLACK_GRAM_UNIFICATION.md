...
**Status:** exact project derivation under Proof Audit 14; manuscript
promotion requires independent proof and literature review.
...
project-derived. The near-ceiling degree-seven and degree-eight exclusions
use one classical external theorem: a connected regular graph with more than
28 vertices and least eigenvalue at least \(-2\) is a line graph or a
cocktail-party graph. This follows from the classification of
Cameron--Goethals--Seidel--Shult, *Journal of Algebra* 43 (1976), 305--327,
DOI `10.1016/0021-8693(76)90162-9`; the statement is also recalled explicitly
in the introduction of Koolen--Yu--Liang--Choi--Markowsky, *European Journal
of Combinatorics* 126 (2025), Article 104118, DOI
`10.1016/j.ejc.2024.104118`. The line-graph arithmetic after this theorem is
proved above and checked exactly by the accompanying verifier.
